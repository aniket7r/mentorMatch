...
// // 
// // import Sidebar from '../../components/before_signup/specific/Messages/Siddebar_new';
// // import ChatWindow from '../../components/before_signup/specific/Messages/chatWindow_new';
// // 
...
//   { name: 'Mentor 1', lastMessage: 'Hello there', messages: [{ text: 'Hello there', isSender: false }] },
//   { name: 'Mentor 2', lastMessage: 'How can I help?', messages: [{ text: 'How can I help?', isSender: false }] },
...
// frontend_mm\src\components\Navbar\Navbar.jsx
import React, { useState, useEffect } from 'react';
...
const dummyConversations = [
  { id: 1, name: 'Mentor 1', lastMessage: 'Hello there', messages: [{ id: 1, text: 'Hello there', isSender: false, time: '14:31' }] },
  { id: 2, name: 'Mentor 2', lastMessage: 'How can I help?', messages: [{ id: 2, text: 'How can I help?', isSender: false, time: '14:32' }] },
  // Add more dummy conversations as needed
];
